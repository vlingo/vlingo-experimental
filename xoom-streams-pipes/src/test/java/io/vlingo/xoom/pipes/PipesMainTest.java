...
import io.vlingo.xoom.pipes.sinks.SubscriptionSink;
import io.vlingo.xoom.pipes.sources.SupplierSource;

public class PipesMainTest {
...
//        );
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        streams.from(streams.http.requestSource(Method.POST, "/"))
                ...
                .flatMapFuture(PipesMainTest::enrich)
